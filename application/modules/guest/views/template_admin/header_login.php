            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="instructor-box menu-icon-box">
                        <div class="icon">
							<?php 
							if ($this->session->userdata('user_role_id') == 5 or $this->session->userdata('user_role_id') == 6) { ?>
								<a href="<?php echo site_url('dashboard/home');?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0; min-width: 100px;">Dashboard</a>							
							<?php 
								} else if ($this->session->userdata('user_role_id') == 5 or $this->session->userdata('user_role_id') == 6) { ?>
								<a href="<?php echo site_url('admin/home');?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0; min-width: 100px;">Dashboard</a>
							<?php } ?>
						</div>
                    </div>
					...
					<?php 
					  unset($datato);
					  $datato['table'] = 'gurumaya.cart';
					  $datato['where'] = array(
						'gurumaya.cart.user_id' => base64_decode($this->session->userdata('user_id'))
					  );
					  $Cart = $this->crud->view_data($datato);
					  $total_cart = $Cart->num_rows();
					?>
