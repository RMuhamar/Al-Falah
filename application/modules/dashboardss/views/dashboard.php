        ...
        <div class="row">
            <div class="col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo site_url('dashboard/my_messages"'); ?>">My messages</a></li>
                    <li><a href="<?php echo site_url('dashboard/purchase_history"'); ?>">Purchase history</a></li>
                    <li><a href="<?php echo site_url('dashboard/user_profile"'); ?>">User profile</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-baseline">
            <div class="col-lg-6">
                <div class="my-course-filter-bar filter-box">
                    ...
                    <div class="btn-group">
                        <a href="http://localhost/academy/home/my_courses" class="btn reset-btn" disabled>Reset</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-3">
                <div class="course-box-wrap">
                    <div class="course-box">
                        <a href="http://localhost/academy/home/lesson/starting-out-assessment-center/1">
                        ...
                        <div class="" id="course_info_view_1">
                            ...
                            <div class="row" style="padding: 5px;">
                                <div class="col-md-6">
                                    <a href="http://localhost/academy/home/course/starting-out-assessment-center/1" class="btn">Course detail</a>
                                </div>
                                <div class="col-md-6">
                                    <a href="http://localhost/academy/home/lesson/starting-out-assessment-center/1" class="btn">Start lesson</a>
                                </div>
                            </div>
                        </div>
