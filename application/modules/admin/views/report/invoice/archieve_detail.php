...
<div class="row">
	<div class="col-sm-12 text-right">
		<h4 class="header-title mb-3">
			<a href="<?php echo site_url('admin/report/invoice/archive'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> Kembali&nbsp;</a>
			<br>
		</h4>
	</div>
</div>
