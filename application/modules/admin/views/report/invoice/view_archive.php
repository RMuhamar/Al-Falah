		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="nav nav-tabs nav-bordered mb-3">
					<li class="nav-item">
						<a href="<?php echo site_url('admin/report/invoice/process'); ?>" aria-expanded="false" class="nav-link">
					...
					<li class="nav-item">
						<a href="<?php echo site_url('admin/report/invoice/archive'); ?>" aria-expanded="true" class="nav-link active">
				...
				<table id="basic-datatable" class="table table-striped table-centered mb-0">
					...
					<tbody>
						...
						foreach ($get_data->result() as $value) :
							// Encrypt ID
							$encrypt_id					= $this->encrypt->encode($value->trx_archive_id);
								...
								<td>
									<div class="dropright dropright">
										...
										<ul class="dropdown-menu">
											<li><a class="dropdown-item" href="<?php echo site_url('admin/report/invoice/archieve_detail?id='.$id) ?>">Detail</a></li>
											<li><a class="dropdown-item" href="<?php echo site_url('admin/report/invoice/print_pdf_archieve?id='.$id) ?>" target="_blank">Print</a></li>										
										</ul>
									</div>
								</td>
							</tr>
