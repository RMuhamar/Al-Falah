		...
		<div class="card">
			<div class="card-body">
				...
				<h4 class="header-title mb-3">
					<a href="<?php echo site_url('admin/master_data/category/'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> kembali</a>
				</h4>
				...
				<div class="col-lg-12">
					<form class="required-form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" id="category_name" name="category_name" class="form-control" placeholder="Kategori" value="<?php echo $category_name; ?>" required="">
						</div>
