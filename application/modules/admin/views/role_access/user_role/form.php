		...
		<div class="card">
			<div class="card-body">
				...
				<h4 class="header-title mb-3">
					<a href="<?php echo site_url('admin/role_access/user_role/'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> kembali</a>
				</h4>
				...
				<div class="col-lg-12">
					<form class="required-form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="user_role_name"></label>
						...
						<div class="form-group">
							<label for="user_role_name">Nama User Role<span class="required">*</span></label>
							<input type="text" id="user_role_name" name="user_role_name" class="form-control" placeholder="Nama User Role" value="<?php echo $user_role_name; ?>" required="">
						</div>
