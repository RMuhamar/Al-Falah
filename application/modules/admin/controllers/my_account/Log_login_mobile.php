...
class Log_login_mobile extends MY_Controller
{
	...
	private $var_uri_seg_3  			= 'log_login_mobile';
	...
	public function index()
	{
		...
		$page_data['content'] 		= 'my_account/log_login_mobile/view';
	...
	public function export_excel()
	{
		...
		foreach($Q1->result() as $R1){
			...
			$excel->getActiveSheet()->setCellValueByColumnAndRow($index++, $excel_row, $R1->log_version);
			$excel_row++;
		}
