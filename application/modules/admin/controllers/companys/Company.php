...
class Company extends MY_Controller
{
	...
	public function export_excel()
	{
		...
		$excel_row = 2;
		unset($datato);
		$datato['table'] = 'ptc_in__recruitment.data_company';
		...
		foreach($Q1->result() as $R1){
			...
			$excel->getActiveSheet()->setCellValueByColumnAndRow($index++, $excel_row, $R1->company_active);
			$excel->getActiveSheet()->setCellValueByColumnAndRow($index++, $excel_row, $R1->company_created_by);
			$excel->getActiveSheet()->setCellValueByColumnAndRow($index++, $excel_row, $R1->company_created_date);
			$excel->getActiveSheet()->setCellValueByColumnAndRow($index++, $excel_row, $R1->company_modified_by);
