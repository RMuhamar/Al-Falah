...
<head>
  ...
  <link href="<?php echo base_url() . 'assets/guest/default/css/datepicker3.css'; ?>" rel="stylesheet" type="text/css" />
  <!-- font awesome 5 -->
  ...
  <script src="<?php echo base_url('assets/guest/default/js/bootstrap-datepicker.js'); ?>"></script>
  <script src="<?php echo base_url('assets/guest/default/js/bootstrap-datepicker.id.min'); ?>"></script>
      ...
      <div class="row">
        <div class="col-md-6">
          <p class="copyright-text">
            ...
            <a href="<?php echo get_settings('footer_link'); ?>" target="_blank"></a>
          </p>
        </div>
        <div class="col-md-6">
