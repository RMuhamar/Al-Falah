                ...
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                <li><a href="<?php echo site_url('dashboard/history_login/web'); ?>">Website</a></li>
                                <li class="active"><a href="<?php echo site_url('dashboard/history_login/mobile'); ?>">Mobile</a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <?php
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>IP : <?php echo $value->log_ipaddress; ?><br>Platform : <?php echo $value->log_platform; ?><br>Platform : <?php echo $value->log_platform; ?></td>
